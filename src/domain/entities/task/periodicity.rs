...
// Settings to apply to each occurrence generated by the periodicity
// ========================================================================

/// Settings that define timing preferences for task occurrences
/// 
/// These settings are primarily used by the infrastructure layer to:
/// - Determine how long an occurrence should take (duration)
/// - Suggest optimal times to complete the task (not_before/best_before)
/// - Provide per-repetition scheduling hints
/// 
/// # Examples
/// 
/// ```rust
...
/// Timing settings for a specific repetition within a time unit
/// 
/// # Examples
/// 
/// ```rust
...
/// let settings = OccurrenceTimingSettings {
///     duration: Some(5), // 5 minutes to take medication
///     not_before: None,
///     best_before: None,
...
pub struct Periodicity {
    ...
    /// Settings for each repetition scaled on the day level (e.g., for 3x/day, each rep must have its own settings or defaults)
    pub occurrence_settings: Option<OccurrenceTimingSettings>,
